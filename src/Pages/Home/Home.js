...
const Home = () => {
    return (
        ...
        <div className="content-container">
            <div id="section1" className="row text-container align-items-center">
                <div className="column align-items-center">
                    ...
                    <div className="para anim-fade-in"> 
                        ...
                        <li> Stimuli comprises of non-sense symmetrical VCV <i>(Vowel-Consonant-Vowel)</i> utterances as part of the sentence <b>"speak VCV today"</b> in three different speaking rates: <b>slow, normal, and fast</b> with 3 repetitions each. </li>
                        ...
                        <li> Ten non-native English speakers: 5 female and 5 male in the age range of 18 to 27 years with no speech related disorders. </li>
                        <li>Recordings were made in the sound damped studio at the <a className="link-style" href="https://spire.ee.iisc.ac.in/spire/ema.php" target="_blank" rel="noreferrer">SPIRE Lab's</a> speech recording facility. Acoustic and articulatory 
